...
const Bestseller = () => {
  ...
  const fetchProductData = async () => {
    const res = await fetch(
      "https://commerce-backend-test.onrender.com/api/product/bestsellers"
    );
              ...
              <div className="bestseller-col-lg-7 col-lg-7 pos-rel h-auto mb-30">
                ...
                <div className="h-100 bg-light p-30">
                  ...
                  <p className="mb-4">
                    ...
                    erat diam stet sit clita ea. Sanc ipsum et, labore clita
                    lorem magna duo dolor no sea Nonumy
                  </p>
                  {/* <div className="d-flex mb-3">
